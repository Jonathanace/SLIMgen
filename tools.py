...
def set_project(
    ...
    try:
        ...
        return str(project) + "is now set as the project directory. What else can I do for you today?"
...
def test_read_code():
    ...
    chat_result = assistant.initiate_chat(user_proxy, message="Please enter your project's relative path:", clear_history=True, silent=False)
    return
